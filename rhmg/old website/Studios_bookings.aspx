        ...
        <asp:TableRow>
            <asp:TableCell VerticalAlign="Top">
                <asp:Label ID="Label1" runat="server" CssClass="title" Text="Rock Hard Studios - Bookings"
                    ToolTip="Book your recording or rehearsal at Rock Hard Studios, Blackpool; whether you are in a band or are a solo artist" />
                <asp:Panel ID="Panel2" runat="server" CssClass="text">
                    Booking into Rock Hard Studios is quick and simple - just give us a <span title="01253 749761">
                        call</span> any day between 10am and 11pm or alternatively use the online booking
                    form below and we'll contact you the next working day.
                </asp:Panel>
                <asp:Panel ID="Panel1" runat="server" CssClass="text">
                    ...
                    <asp:HyperLink runat="server" NavigateUrl="~/TermsAndConditions.aspx" Text="terms and conditions"
                        class="standardLinkInactive" ToolTip="The terms and conditions of working with Rock Hard Studios, Blackpool Lancashire" />
...
<asp:Content ID="Content1" ContentPlaceHolderID="BottomBannerContentPlaceHolder"
    ...
    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/banners/Recording Studio Hand On Desk Blackpool.jpg"
        AlternateText="Rock Hard Studios - Digidesign C24 Control Surface :: professional recording and rehearsing in Blackpool, Lancashire"
        ToolTip="Rock Hard Studios - Digidesign C24 Control Surface :: professional recording and rehearsing in Blackpool, Lancashire" />
</asp:Content>
