                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Panel ID="Panel1" runat="server" CssClass="text">
                                            ...
                                            <asp:HyperLink ID="HyperLink24" runat="server" Text="- Backing Tracks" Style="margin-left: 90px;"
                                                CssClass="standardLink" NavigateUrl="~/Studios_recording_backing_tracks.aspx" /><br />
                                            ...
                                            <asp:HyperLink ID="HyperLink23" runat="server" Text="- Customers" Style="margin-left: 30px;"
                                                CssClass="externalLink" NavigateUrl="~/Customers.aspx" Target="_blank" /><br />
