...
<asp:Table runat="server" ID="ContactUsTable" BackImageUrl="~/images/backgrounds/full.png"
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            <asp:HyperLink runat="server" CssClass="standardLink" ToolTip="Email Rock Hard Studios, Blackpool, Lancashire for recording or rehearsal information for bands or solo artists" Text="enquiries@rhmg.co.uk" NavigateUrl="mailto:enquiries@rhmg.co.uk" Target="_blank" />
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        <asp:TableCell>
