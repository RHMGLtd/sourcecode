...
<asp:Table ID="Table1" runat="server" CellPadding="0" CellSpacing="0" Width="72px">
    ...
    <asp:TableRow>
        <asp:TableCell CssClass="sidePanelMiddle">
            ...
            <br />
            <asp:HyperLink runat="server" ID="sitemapHL" NavigateUrl="~/Sitemap.aspx" ToolTip="Click here for a simple sitemap of the Rock Hard Music Group website, running the best Recording and Rehearsal facility for bands and solo artists in Blackpool, Lancashire"
                CssClass="sidepanelLink" Text="site map" />
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
    ...
    <asp:TableRow>
        <asp:TableCell HorizontalAlign="Center">
            <asp:Image runat="server" ImageUrl="~/images/how to pay for your studio time.png" AlternateText="How to pay for your recordings or rehearsals at Rock Hard Studios, Blackpool, Lancashire: mastercard, visa, maestro, switch, solo" ToolTip="How to pay for your studio time: mastercard, visa, maestro, switch, solo" />
        </asp:TableCell>
    </asp:TableRow>
</asp:Table>
