    ...
    <asp:Table ID="Table1" runat="server">
        <asp:TableRow>
            <asp:TableCell VerticalAlign="Top" ColumnSpan="2">
                ...
                <asp:Panel ID="Panel1" runat="server" CssClass="text" ToolTip="Specific products at Rock Hard Studios, Blackpool, Lancashire - we don't just do recording and rehearsals for bands or solo artists">
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Panel ID="Panel3" runat="server" CssClass="text">
                    Do you fancy yourself as a singer? Do you think you could do as well as, or better
                    than, your favourite artist? Rock Hard Studios has the perfect product for you;
                    An opportunity to come into the studio and sing to your favourite <a href="Studios_recording_backing_tracks.aspx"
                        class="standardLinkInactive">backing tracks</a>. Click the picture to find out
                    more.
                </asp:Panel>
            </asp:TableCell>
            <asp:TableCell VerticalAlign="Top" Width="410px">
                <a href="PopstarExperience.aspx">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/products/Pop Star Experience - Have a full on Pop Star Experience in Blackpool Lancashire.png"
                        AlternateText="Pop Star Experience - Have a full on Pop Star Experience in Blackpool Lancashire"
                        ToolTip="Pop Star Experience - Have a full on Pop Star Experience in Blackpool Lancashire" />
                </a>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
