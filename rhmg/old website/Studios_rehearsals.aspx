        ...
        <asp:TableRow>
            <asp:TableCell Width="400px">
                <asp:Label ID="Label1" runat="server" CssClass="title" Text="Rock Hard Studios - Rehearsals"
                    ToolTip="Rehearsing at Rock Hard Studios, Blackpool, Lancashire - THE best rehearsal studio for bands or solo artists." />
            </asp:TableCell>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/photos/explore_the_studio/Rock Hard Studios Blackpool Rehearsal Room 4 including Sonor drum kit_.jpg"
                        AlternateText="Rock Hard Studios - Rehearsal Room 4, including Sonor drum kit :: quality rehearsals for bands or solo artists in Blackpool, Lancashire"
                        ToolTip="Rock Hard Studios - Rehearsal Room 4, including Sonor drum kit :: quality rehearsals for bands or solo artists in Blackpool, Lancashire" /></asp:TableCell>
                <asp:TableCell Width="25px"></asp:TableCell>
                <asp:TableCell>
                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/photos/explore_the_studio/Rock Hard Studios Blackpool Our fully stocked kitchen_.jpg"
                        AlternateText="Rock Hard Studios - Our fully stocked kitchen :: an excellent offering for bands and solo artists rehearsing in Blackpool, Lancashire"
                        ToolTip="Rock Hard Studios - Our fully stocked kitchen :: an excellent offering for bands and solo artists rehearsing in Blackpool, Lancashire" /></asp:TableCell>
                <asp:TableCell Width="25px"></asp:TableCell>
                <asp:TableCell>
                    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/photos/explore_the_studio/Rock Hard Studios Blackpool The corridor with rehearsal rooms on the left and recording studio on the right_.jpg"
                        AlternateText="Rock Hard Studios - The corridor with rehearsal rooms on the left, and recording studio on the right :: a professional option for rehearsing with your band in Blackpool, Lancashire"
                        ToolTip="Rock Hard Studios - The corridor with rehearsal rooms on the left, and recording studio on the right :: a professional option for rehearsing with your band in Blackpool, Lancashire" /></asp:TableCell>
                <asp:TableCell Width="25px"></asp:TableCell>
                <asp:TableCell>
