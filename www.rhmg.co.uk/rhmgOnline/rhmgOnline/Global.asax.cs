...
namespace rhmgOnline
{
    public class MvcApplication : HttpApplication, IWindsorApplication
    {
        ...
        private static BasedOnDescriptor RegisterFromNamespaceEndingWith(string ns)
        {
        ...
        private static BasedOnDescriptor Defaults()
        {
            return RegisterFromNamespaceEndingWith(".Default");
        }
