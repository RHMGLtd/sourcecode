...
namespace System.Web.Mvc
{
                                       ...
                                       IExceptionFilter, IResultFilter
    {
        ...
        protected internal virtual FileContentResult File(byte[] fileContents, string contentType,
        ...
        protected internal virtual RedirectToRouteResult RedirectToAction(string actionName, string controllerName,
        ...
        protected internal bool TryUpdateModel<TModel>(TModel model, string prefix, string[] includeProperties,
                                                       string[] excludeProperties) where TModel : class;

        protected internal bool TryUpdateModel<TModel>(TModel model, IValueProvider valueProvider) where TModel : class;

        protected internal bool TryUpdateModel<TModel>(TModel model, string prefix, IValueProvider valueProvider)
            where TModel : class;
        ...
        protected internal void UpdateModel<TModel>(TModel model, string prefix, string[] includeProperties)
            where TModel : class;
        ...
        protected internal void UpdateModel<TModel>(TModel model, string prefix, IValueProvider valueProvider)
            where TModel : class;
